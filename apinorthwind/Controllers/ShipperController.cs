...
namespace apinorthwind.Controllers
{
    ...
    public class ShipperController: Controller
    {
           ...
           "Server=(localdb)\\mssqllocaldb;Database=NorthwindMock;Trusted_Connection=True;MultipleActiveResultSets=true";
            ...
            public ShipperController(NorthwindDbContext context)
            {
                this._context = context;
            }
            [HttpGet]
        [LogApiDetails]
        public async Task<List<Shipper>> GetAllOrders()
            {
        ...
        [ProducesResponseType(typeof(int), StatusCodes.Status200OK)]
            ...
            public async Task<IActionResult> GetById(int id)
            {
                ...
                var order = await _context.Shippers.FindAsync(id);
        ...
        [ProducesResponseType(typeof(int), StatusCodes.Status201Created)]
            ...
            public async Task<IActionResult> PostOrder(Shipper order)
            {
                await _context.Shippers.AddAsync(order);
        ...
        [ProducesResponseType(StatusCodes.Status204NoContent)]
            ...
            {
                string sqlCommandText = "DELETE FROM Shippers WHERE id =" + id;
